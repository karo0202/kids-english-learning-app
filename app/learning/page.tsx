...
export default function LearningPage() {
  ...
  const renderLockBadge = (moduleId: string) => {
    ...
    return (
      <div className="absolute top-3 right-3 px-3 py-1.5 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white text-xs font-semibold shadow-lg flex items-center gap-1.5 z-10 ring-2 ring-white/20">
  ...
  const cardBase = 'cursor-pointer group relative overflow-hidden rounded-3xl border border-slate-200/80 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm shadow-xl shadow-slate-200/50 dark:shadow-black/20 hover:shadow-2xl hover:shadow-slate-300/40 dark:hover:shadow-indigo-500/10 hover:border-slate-300/80 dark:hover:border-white/20 hover:-translate-y-1 transition-all duration-300'
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <Sparkles className="w-5 h-5 text-amber-500 dark:text-amber-400 hidden sm:block" />
                  <h1 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-slate-800 to-indigo-700 dark:from-white dark:to-indigo-200 bg-clip-text text-transparent tracking-tight">Learning Center</h1>
      ...
      >
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 md:mb-6">
            <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-slate-800 to-indigo-700 dark:from-white dark:to-indigo-200 bg-clip-text text-transparent tracking-tight">Choose your learning path</h2>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-blue-500 to-indigo-600`}
                  ...
                  <div className="text-sm font-medium text-blue-600 dark:text-blue-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Reading
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-amber-500 to-orange-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-amber-600 dark:text-amber-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start
            ...
            >
              ...
              >
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-emerald-500 to-teal-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-emerald-600 dark:text-emerald-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Writing
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-violet-500 to-fuchsia-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-violet-600 dark:text-violet-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Speaking
            ...
            >
              ...
              >
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-rose-500 to-pink-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-rose-600 dark:text-rose-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Playing
            ...
            >
              ...
              >
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-indigo-500 to-blue-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-indigo-600 dark:text-indigo-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Learning
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-orange-500 to-amber-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-orange-600 dark:text-orange-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Solving
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-cyan-500 to-teal-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
                  ...
                  <div className="text-sm font-medium text-cyan-600 dark:text-cyan-400 group-hover:translate-x-0.5 transition-transform inline-flex items-center gap-1">
                    Start Coloring
            ...
            >
              ...
              >
                ...
                <CardContent className="p-5 md:p-6 text-center relative z-10">
                  <motion.div 
                    className={`${iconBase} bg-gradient-to-br from-rose-500 to-red-600`}
                    whileHover={{ scale: 1.08 }}
                    transition={{ type: 'spring', stiffness: 400 }}
                  >
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4 text-xs md:text-base">
            <motion.div 
              ...
              whileHover={{ scale: 1.02 }}
            >
              <div className="text-2xl md:text-3xl font-bold text-indigo-600 dark:text-indigo-400">0</div>
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.02 }}
            >
              <div className="text-2xl md:text-3xl font-bold text-cyan-600 dark:text-cyan-400">0</div>
