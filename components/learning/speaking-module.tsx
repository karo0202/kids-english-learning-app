...
export default function SpeakingModule() {
  ...
  const roleScenes: RoleScene[] = [
    ...
    {
      title: '🎯 Advanced AI Training Simulator',
      lines: [
        { speaker: 'AI Trainer', text: 'Welcome to the Advanced AI Training Simulator! I will guide you through complex scenarios.' },
        { speaker: 'You', text: 'I am ready to begin the advanced training program.' },
        { speaker: 'AI Trainer', text: 'Excellent! Let us start with a business negotiation simulation. You are meeting with a potential client.' },
        { speaker: 'You', text: 'Good morning. I am excited to discuss our partnership opportunities with your company.' },
        { speaker: 'AI Trainer', text: 'Great opening! The client responds: "We are interested in your services. What makes your company unique?"' },
        { speaker: 'You', text: 'Our company specializes in innovative solutions and has a 99% customer satisfaction rate.' },
        { speaker: 'AI Trainer', text: 'Perfect! The client says: "That sounds impressive. Can you provide some examples of your recent projects?"' },
        { speaker: 'You', text: 'Certainly! We recently completed a project that increased efficiency by 40% for a Fortune 500 company.' },
        { speaker: 'AI Trainer', text: 'Outstanding! The client responds: "That is exactly what we need. When can we schedule a detailed presentation?"' },
        { speaker: 'You', text: 'I can arrange a presentation for next week. Would Tuesday at 2 PM work for your team?' },
        { speaker: 'AI Trainer', text: 'Excellent negotiation skills! You have successfully secured the meeting. Your performance score: 95%' }
      ],
      premium: true
    },
    {
      ...
      lines: [
        { speaker: 'VR Guide', text: 'Welcome to the Virtual Reality Learning Simulator! Put on your VR headset and let us begin.' },
        { speaker: 'You', text: 'I am ready to experience virtual reality learning!' },
        { speaker: 'VR Guide', text: 'Amazing! You are now in a virtual classroom. Look around and tell me what you see.' },
        { speaker: 'You', text: 'I can see a modern classroom with interactive whiteboards and comfortable seating.' },
        { speaker: 'VR Guide', text: 'Perfect! Now, let us practice public speaking. You are giving a presentation to 100 virtual audience members.' },
        { speaker: 'You', text: 'Good morning, everyone. Today I will be discussing the future of technology in education.' },
        { speaker: 'VR Guide', text: 'Excellent! The virtual audience is applauding. Your confidence level has increased by 25%!' },
        { speaker: 'You', text: 'Thank you for this amazing virtual learning experience!' },
        { speaker: 'VR Guide', text: 'You have successfully completed the VR training module. Your overall performance: 98%!' }
      ],
      premium: true
    },
    {
      title: '🎓 University Interview Simulator',
      lines: [
        { speaker: 'Admissions Officer', text: 'Welcome to our university interview simulator! I am Professor Johnson from the admissions committee.' },
        { speaker: 'You', text: 'Hello, Professor Johnson. I am excited to discuss my application.' },
        { speaker: 'Admissions Officer', text: 'Great! Tell me, what motivated you to apply to our university?' },
        { speaker: 'You', text: 'I am passionate about computer science and your university has an excellent reputation in this field.' },
        { speaker: 'Admissions Officer', text: 'That is wonderful! Can you describe a challenging project you have worked on?' },
        { speaker: 'You', text: 'I developed a mobile app that helps students organize their study schedules more efficiently.' },
        { speaker: 'Admissions Officer', text: 'Impressive! What are your career goals after graduation?' },
        { speaker: 'You', text: 'I hope to work in artificial intelligence and contribute to developing technology that benefits society.' },
        { speaker: 'Admissions Officer', text: 'Excellent! You have shown great potential. We will notify you of our decision within two weeks.' }
      ],
      premium: true
    },
    {
